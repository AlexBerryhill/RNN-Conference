"""
This code is based off of the original code from the following GitHub:
https://github.com/johnmwood/LDS-Conference-Scraper/tree/master
Original Author: John Wood
Original Date: 2020-07-01

Author: Alex Berryhill
Date: 2024-03-18

This code is a web scraper that is designed to pull all of the talks from the 
Church of Jesus Christ of Latter-day Saints' General Conference. The scraper
pulls the following data for each talk: title, speaker, calling, conference,
url, talk, and footnotes. The data is then saved to a csv file.
"""
...
def scrape_talk_urls(conference_url):
    ...
    div = soup.find("nav", {"class": "manifest"})
...
def scrape_talk_data(url):
    ...
    try:
        ...
        conference = soup.find("div", {"class": "itemTitle-MXhtV"}).find("p").text
